    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
      ...
      //  showNotification(remoteMessage.getNotification().getTitle(),remoteMessage.getNotification().getBody());
       ...
       // String title = data.get("title").toString();
        ...
        final String logt = data.get("long").toString();
        final String lat = data.get("lat").toString();
        Log.d("tag", "message" + logt + lat);

        SharedPreferences.Editor editor = getSharedPreferences("MY_PREFS_NAME", MODE_PRIVATE).edit();
        editor.putString("longt", logt);
...
//        String notificationchannelId="com.android.mygpstracking";
...
//
//            notificationChannel.setDescription("location channel");
...
//                .setDefaults(Notification.DEFAULT_ALL).setWhen(System.currentTimeMillis()).setSmallIcon(R.drawable.common_google_signin_btn_icon_dark)
